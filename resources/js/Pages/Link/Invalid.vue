...
<template>
    <Head title="Broken Link" />

    <div class="flex items-center w-full h-screen max-h-screen overflow-y-hidden ">
        <div class="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row ">
            <div class="flex flex-col items-center max-w-md gap-3 md:items-start ">
                <div class="text-5xl font-bold font-dark">
                    404
                </div>

                <p class="text-2xl leading-normal md:text-3xl">
                    Broken Link
                </p>

                <p class="mb-8">
                    Whoops, looks like the link is broken or expired
                </p>
            </div>
            <div class="max-w-lg">
